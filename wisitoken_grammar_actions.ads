     ...
     (First_Terminal    => 3,
      ...
      Image               =>
        (new String'("WHITESPACE"),
         ...
         new String'("STRING_LITERAL_DOUBLE"),
         new String'("STRING_LITERAL_SINGLE"),
         new String'("Wisi_EOI"),
