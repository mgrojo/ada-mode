...
begin
   Process_Stream
     (Name, Language_Protocol_Version, Params,
      (Descriptor, Create_Lexer (Trace'Unchecked_Access), Create_Parse_Table, Create_In_Parse_Actions,
       Create_Post_Parse_Actions, Partial_Parse_Active, Partial_Parse_Byte_Goal, Language_Fixes,
