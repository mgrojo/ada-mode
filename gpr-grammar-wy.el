...
(defconst gpr-grammar-wy--parse-table
   ...
   '((AMPERSAND COLON COLON_EQUALS COMMA DOT EQUAL_GREATER QUOTE SEMICOLON VERTICAL_BAR IDENTIFIER STRING_LITERAL ABSTRACT AGGREGATE CASE CONFIGURATION END EXTERNAL EXTERNAL_AS_LIST FOR IS LEFT_PAREN LIBRARY NULL OTHERS PACKAGE PROJECT RENAMES RIGHT_PAREN STANDARD TYPE USE WHEN WITH )
     ((aggregate
     ...
     [((default . error) (ABSTRACT . (context_clause_opt . 0)) (AGGREGATE . (context_clause_opt . 0)) (CONFIGURATION . (context_clause_opt . 0)) (LIBRARY . (context_clause_opt . 0)) (STANDARD . (context_clause_opt . 0)) (PROJECT . (context_clause_opt . 0)) ($EOI . (context_clause_opt . 0)) (WITH .  7))
      ...
      ((default . error) ($EOI . accept) (STRING_LITERAL . accept) (IDENTIFIER . accept) (VERTICAL_BAR . accept) (SEMICOLON . accept) (QUOTE . accept) (EQUAL_GREATER . accept) (DOT . accept) (COMMA . accept) (COLON_EQUALS . accept) (COLON . accept) (AMPERSAND . accept) (WITH . accept) (WHEN . accept) (USE . accept) (TYPE . accept) (STANDARD . accept) (RIGHT_PAREN . accept) (RENAMES . accept) (PROJECT . accept) (PACKAGE . accept) (OTHERS . accept) (NULL . accept) (LIBRARY . accept) (LEFT_PAREN . accept) (IS . accept) (FOR . accept) (EXTERNAL_AS_LIST . accept) (EXTERNAL . accept) (END . accept) (CONFIGURATION . accept) (CASE . accept) (AGGREGATE . accept) (ABSTRACT . accept))
      ...
      ((default . error) (RIGHT_PAREN . (identifier_opt . 1)) (COMMA . (identifier_opt . 1)) (IS . (identifier_opt . 1)) (RENAMES . (identifier_opt . 1)) (DOT . (identifier_opt . 1)) (AMPERSAND . (identifier_opt . 1)) (SEMICOLON . (identifier_opt . 1)) (QUOTE . (identifier_opt . 1)))
      ...
      ((default . error) (END . (declarative_items_opt . 0)) (TYPE .  56) (IDENTIFIER .  57) (NULL .  54) (CASE .  52) (FOR .  53) (PACKAGE .  55))
      ...
      ((default . error) (LEFT_PAREN .  77) (COMMA . (attribute_reference . 0)) (RIGHT_PAREN . (attribute_reference . 0)) (SEMICOLON . (attribute_reference . 0)) (AMPERSAND . (attribute_reference . 0)))
      ...
      ((default . error) (IS . (identifier_opt . 0)) (RENAMES . (identifier_opt . 0)) (IDENTIFIER .  20))
      ((default . error) (IDENTIFIER .  72))
      ((default . error) (COLON .  70) (COLON_EQUALS .  71))
      ...
      ((default . error) (WHEN . (declarative_items_opt . 1)) (END . (declarative_items_opt . 1)) (TYPE .  56) (IDENTIFIER .  57) (NULL .  54) (CASE .  52) (FOR .  53) (PACKAGE .  55))
      ((default . error) (END .  68))
      ...
      ((default . error) (IS .  84))
      ((default . error) (IS .  82) (RENAMES .  83))
      ...
      ((default . error) (STRING_LITERAL .  78))
      ((default . error) (RIGHT_PAREN .  99))
      ((default . error) (END . (case_items . 0)) (WHEN . ( 96 (case_items . 0))))
      ((default . error) (STRING_LITERAL .  95))
      ((default . error) (LEFT_PAREN .  18) (STRING_LITERAL .  21) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  20) (PROJECT .  19))
      ((default . error) (END . (declarative_items_opt . 0)) (TYPE .  56) (IDENTIFIER .  57) (NULL .  54) (CASE .  52) (FOR .  53) (PACKAGE .  55))
      ((default . error) (DOT . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (IDENTIFIER .  20))
      ((default . error) (LEFT_PAREN .  43))
      ((default . error) (AMPERSAND .  39) (SEMICOLON .  90))
      ((default . error) (COLON_EQUALS .  89))
      ((default . error) (SEMICOLON .  88))
      ...
      ((default . error) (DOT .  38) (SEMICOLON .  109))
      ((default . error) (END .  108))
      ((default . error) (AMPERSAND .  39) (SEMICOLON .  107))
      ((default . error) (RIGHT_PAREN .  106))
      ((default . error) (VERTICAL_BAR . (discrete_choice . 0)) (EQUAL_GREATER . (discrete_choice . 0)) (STRING_LITERAL .  103) (OTHERS .  102))
      ((default . error) (END . (case_items . 1)) (WHEN . (case_items . 1)))
      ((default . error) (END .  100) (WHEN .  96))
      ...
      ((default . error) (AMPERSAND .  39) (SEMICOLON .  112))
      ...
      ((default . error) (LEFT_PAREN .  18) (STRING_LITERAL .  21) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  20) (PROJECT .  19))
      ((default . error) (END . (declarative_items_opt . 0)) (WHEN . (declarative_items_opt . 0)) (TYPE .  56) (IDENTIFIER .  57) (NULL .  54) (CASE .  52) (FOR .  53) (PACKAGE .  55))
      ((default . error) (EQUAL_GREATER . (discrete_choice . 0)) (VERTICAL_BAR . (discrete_choice . 0)) (STRING_LITERAL .  103) (OTHERS .  102))
      ...
      ((default . error) (AMPERSAND .  39) (SEMICOLON .  123))
     ...
     [((compilation_unit . 8)(context_clause . 9)(context_clause_opt . 10)(simple_project_declaration . 11)(with_clause . 12))
      ...
      nil
      nil
      ((attribute_declaration . 58)(case_statement . 59)(declarative_item . 60)(declarative_items . 61)(declarative_items_opt . 62)(package_declaration . 63)(package_spec . 64)(package_renaming . 65)(simple_declarative_item . 66)(typed_string_declaration . 67))
      ...
      nil
      nil
      ((attribute_declaration . 58)(case_statement . 59)(declarative_item . 69)(package_declaration . 63)(package_spec . 64)(package_renaming . 65)(simple_declarative_item . 66)(typed_string_declaration . 67))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 22)(attribute_prefix . 23)(attribute_reference . 24)(expression . 85)(external_value . 26)(identifier_opt . 27)(name . 28)(string_expression . 29)(string_primary . 30)(term . 32))
      nil
      nil
      nil
      nil
      ...
      nil
      ((aggregate . 22)(attribute_prefix . 23)(attribute_reference . 24)(expression . 94)(external_value . 26)(identifier_opt . 27)(name . 28)(string_expression . 29)(string_primary . 30)(term . 32))
      ((attribute_declaration . 58)(case_statement . 59)(declarative_item . 60)(declarative_items . 61)(declarative_items_opt . 93)(package_declaration . 63)(package_spec . 64)(package_renaming . 65)(simple_declarative_item . 66)(typed_string_declaration . 67))
      ((identifier_opt . 27)(name . 92))
      ((aggregate . 91))
      nil
      nil
      nil
      nil
      ((aggregate . 22)(attribute_prefix . 23)(attribute_reference . 24)(expression . 111)(external_value . 26)(identifier_opt . 27)(name . 28)(string_expression . 29)(string_primary . 30)(term . 32))
      nil
      nil
      nil
      nil
      nil
      nil
      ((discrete_choice . 104)(discrete_choice_list . 105))
      nil
      ((case_item . 101))
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 22)(attribute_prefix . 23)(attribute_reference . 24)(expression . 121)(external_value . 26)(identifier_opt . 27)(name . 28)(string_expression . 29)(string_primary . 30)(term . 32))
      ((attribute_declaration . 58)(case_statement . 59)(declarative_item . 60)(declarative_items . 61)(declarative_items_opt . 120)(package_declaration . 63)(package_spec . 64)(package_renaming . 65)(simple_declarative_item . 66)(typed_string_declaration . 67))
      ((discrete_choice . 119))
      nil
      nil
      nil
