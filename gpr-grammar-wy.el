...
(defconst gpr-grammar-wy--parse-table
   ...
   '((AMPERSAND COLON COLON_EQUALS COMMA DOT EQUAL_GREATER QUOTE SEMICOLON VERTICAL_BAR IDENTIFIER STRING_LITERAL ABSTRACT AGGREGATE CASE CONFIGURATION END EXTERNAL EXTERNAL_AS_LIST FOR IS LEFT_PAREN LIBRARY NULL OTHERS PACKAGE PROJECT RIGHT_PAREN STANDARD TYPE USE WHEN WITH )
     ...
     [((default . error) (ABSTRACT . (context_clause_opt . 0)) (AGGREGATE . (context_clause_opt . 0)) (CONFIGURATION . (context_clause_opt . 0)) (LIBRARY . (context_clause_opt . 0)) (STANDARD . (context_clause_opt . 0)) (PROJECT . (context_clause_opt . 0)) ($EOI . (context_clause_opt . 0)) (WITH .  7))
      ...
      ((default . error) (IS . (identifier_opt . 0)) (IDENTIFIER .  19))
      ((default . error) ($EOI . (project_qualifier_opt . 2)) (PROJECT . (project_qualifier_opt . 2)))
      ((default . error) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (COMMA . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ...
      ((default . error) (END . (declarative_items . 0)) (TYPE . ( 50 (declarative_items . 0))) (IDENTIFIER . ( 51 (declarative_items . 0))) (NULL . ( 48 (declarative_items . 0))) (CASE . ( 46 (declarative_items . 0))) (FOR . ( 47 (declarative_items . 0))) (PACKAGE . ( 49 (declarative_items . 0))))
      ((default . error) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (RIGHT_PAREN . (identifier_opt . 0)) (COMMA . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ...
      ((default . error) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (COMMA . (identifier_opt . 0)) (RIGHT_PAREN . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ((default . error) (IDENTIFIER .  43))
      ((default . error) (IDENTIFIER .  42))
      ((default . error) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (RIGHT_PAREN . (identifier_opt . 0)) (COMMA . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ...
      ((default . error) (DOT . (identifier_opt . 0)) (IS . (identifier_opt . 0)) (IDENTIFIER .  19))
      ((default . error) (IDENTIFIER .  67))
      ((default . error) (SEMICOLON .  66))
      ((default . error) (IS . (identifier_opt . 0)) (IDENTIFIER .  19))
      ((default . error) (IDENTIFIER .  64))
      ((default . error) (COLON .  62) (COLON_EQUALS .  63))
      ...
      ((default . error) (END .  60) (TYPE .  50) (IDENTIFIER .  51) (NULL .  48) (CASE .  46) (FOR .  47) (PACKAGE .  49))
      ...
      ((default . error) (SEMICOLON . (identifier_opt . 0)) (IDENTIFIER .  19))
      ...
      ((default . error) (LEFT_PAREN .  77) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ((default . error) (IS .  76))
      ((default . error) (IS .  75))
      ...
      ((default . error) (USE .  74) (LEFT_PAREN .  73))
      ((default . error) (DOT .  35) (IS .  72))
      ((default . error) (STRING_LITERAL .  71))
      ((default . error) (AMPERSAND . (aggregate . 0)) (RIGHT_PAREN . (aggregate . 0)) (COMMA . (aggregate . 0)) (SEMICOLON . (aggregate . 0)))
      ((default . error) (RIGHT_PAREN .  97))
      ((default . error) (END . (case_items . 0)) (WHEN . ( 94 (case_items . 0))))
      ((default . error) (STRING_LITERAL .  93))
      ((default . error) (LEFT_PAREN .  77) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ((default . error) (END . (simple_declarative_items . 0)) (IDENTIFIER . ( 51 (simple_declarative_items . 0))) (NULL . ( 48 (simple_declarative_items . 0))) (CASE . ( 46 (simple_declarative_items . 0))) (FOR . ( 47 (simple_declarative_items . 0))))
      ((default . error) (LEFT_PAREN .  37))
      ((default . error) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (RIGHT_PAREN . ( 88 (identifier_opt . 0))) (COMMA . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ((default . error) (AMPERSAND . (term . 2)) (SEMICOLON . (term . 2)))
      ((default . error) (AMPERSAND .  86) (SEMICOLON .  87))
      ((default . error) (SEMICOLON . (term . 0)) (AMPERSAND . ( 34 (term . 0))))
      ...
      ((default . error) (LEFT_PAREN .  77) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ((default . error) (LEFT_PAREN .  77) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ...
      ((default . error) (END .  106) (IDENTIFIER .  51) (NULL .  48) (CASE .  46) (FOR .  47))
      ((default . error) (AMPERSAND .  86) (SEMICOLON .  105))
      ((default . error) (RIGHT_PAREN .  104))
      ((default . error) (VERTICAL_BAR . (discrete_choice . 0)) (EQUAL_GREATER . (discrete_choice . 0)) (STRING_LITERAL .  101) (OTHERS .  100))
      ((default . error) (END . (case_items . 1)) (WHEN . (case_items . 1)))
      ((default . error) (END .  98) (WHEN .  94))
      ...
      ((default . error) (VERTICAL_BAR .  115) (EQUAL_GREATER .  114))
      ((default . error) (USE .  113))
      ...
      ((default . error) (SEMICOLON .  121))
      ((default . error) (LEFT_PAREN .  77) (STRING_LITERAL .  20) (EXTERNAL .  16) (EXTERNAL_AS_LIST .  17) (DOT . (identifier_opt . 0)) (AMPERSAND . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (QUOTE . (identifier_opt . 0)) (IDENTIFIER .  19) (PROJECT .  18))
      ((default . error) (END . (declarative_items . 0)) (WHEN . (declarative_items . 0)) (TYPE . ( 50 (declarative_items . 0))) (IDENTIFIER . ( 51 (declarative_items . 0))) (NULL . ( 48 (declarative_items . 0))) (CASE . ( 46 (declarative_items . 0))) (FOR . ( 47 (declarative_items . 0))) (PACKAGE . ( 49 (declarative_items . 0))))
      ((default . error) (EQUAL_GREATER . (discrete_choice . 0)) (VERTICAL_BAR . (discrete_choice . 0)) (STRING_LITERAL .  101) (OTHERS .  100))
      ...
      ((default . error) (END . (case_item . 0)) (WHEN . (case_item . 0)) (TYPE .  50) (IDENTIFIER .  51) (NULL .  48) (CASE .  46) (FOR .  47) (PACKAGE .  49))
      ((default . error) (AMPERSAND .  86) (SEMICOLON .  122))
     ...
     [((compilation_unit . 8)(context_clause . 9)(context_clause_opt . 10)(simple_project_declaration . 11)(with_clause . 12))
      ...
      nil
      nil
      ((project_declaration_opt . 40)(simple_project_declaration . 11))
      nil
      nil
      ((aggregate . 39))
      ((aggregate . 38))
      ...
      nil
      nil
      ((aggregate . 78)(attribute_prefix . 21)(attribute_reference . 22)(expression . 79)(external_value . 23)(identifier_opt . 24)(name . 25)(string_expression . 80)(string_primary . 27)(term . 81))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((case_item . 95)(case_items . 96))
      nil
      ((aggregate . 78)(attribute_prefix . 21)(attribute_reference . 22)(expression . 92)(external_value . 23)(identifier_opt . 24)(name . 25)(string_expression . 80)(string_primary . 27)(term . 81))
      ((attribute_declaration . 52)(case_statement . 53)(simple_declarative_item . 90)(simple_declarative_items . 91))
      ((aggregate . 89))
      ((attribute_prefix . 21)(attribute_reference . 22)(external_value . 23)(identifier_opt . 24)(name . 25)(string_expression . 26)(string_primary . 27)(string_list . 41))
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 78)(attribute_prefix . 21)(attribute_reference . 22)(expression . 110)(external_value . 23)(identifier_opt . 24)(name . 25)(string_expression . 80)(string_primary . 27)(term . 81))
      ((aggregate . 78)(attribute_prefix . 21)(attribute_reference . 22)(external_value . 23)(identifier_opt . 24)(name . 25)(string_expression . 80)(string_primary . 27)(term . 109))
      nil
      nil
      nil
      nil
      ((attribute_declaration . 52)(case_statement . 53)(simple_declarative_item . 107))
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 78)(attribute_prefix . 21)(attribute_reference . 22)(expression . 120)(external_value . 23)(identifier_opt . 24)(name . 25)(string_expression . 80)(string_primary . 27)(term . 81))
      ((attribute_declaration . 52)(case_statement . 53)(declarative_item . 54)(declarative_items . 119)(package_declaration . 56)(package_spec . 57)(simple_declarative_item . 58)(typed_string_declaration . 59))
      ((discrete_choice . 118))
      nil
      nil
      nil
