...
with Ada_Annex_P_Process_Packrat_Proc_Main;
with Gen_Run_Wisi_Packrat_Proc_Parse;
--  FIXME: packrat support error recover. with WisiToken.Parse.LR.McKenzie_Recover.Ada;
with Wisi.Ada;
procedure Run_Ada_Packrat_Proc_Parse is new Gen_Run_Wisi_Packrat_Proc_Parse
  (Parse_Data_Type => Wisi.Ada.Parse_Data_Type,
   Create_Parser   => Ada_Annex_P_Process_Packrat_Proc_Main.Create_Parser);
