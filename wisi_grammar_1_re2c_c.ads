...
with WisiToken;
with System;
package wisi_grammar_1_re2c_c is
   ...
   with Import        => True,
        Convention    => C,
        External_Name => "wisi_grammar_1_next_token";

end wisi_grammar_1_re2c_c;
