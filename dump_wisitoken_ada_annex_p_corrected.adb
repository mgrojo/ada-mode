...
procedure Dump_WisiToken_Ada_Annex_P_Corrected
is
   use WisiToken;
   ...
   Trace  : aliased WisiToken.Text_IO_Trace.Trace (Ada_Annex_P_Process_Actions.Descriptor'Unrestricted_Access);
      ...
      if Argument (1) = "LR1" then
         Ada_Annex_P_Process_LR1_Main.Create_Parser
           (Parser,
            ...
            User_Data => null,
            Text_Rep_File_Name => Containing_Directory (Command_Name) & "/ada_annex_p_lr1_re2c_parse_table.txt");
      else
...
end Dump_WisiToken_Ada_Annex_P_Corrected;
