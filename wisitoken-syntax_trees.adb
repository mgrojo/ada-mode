...
package body WisiToken.Syntax_Trees is
   ...
   begin
      ...
      then
         ...
         Tree.Last_Source_Terminal (Next_Source_Terminal, Trailing_Non_Grammar, Parse_Stream);
   ...
   function ID (Tree : in Syntax_Trees.Tree; Node : in Valid_Node_Access) return Token_ID
   is
      pragma Unreferenced (Tree);
   begin
      return Node.ID;
   ...
   begin
      if Element = Invalid_Stream_Index then
         ...
         return Line_At_Node (Tree, Tree.To_Stream_Node_Parents (Tree.To_Rooted_Ref (Stream, Element)), Stream);
      end if;
   end Line_At_Node;
   ...
   begin
      ...
      return Temp.Ref.Node.Non_Grammar (Temp.Ref.Node.Non_Grammar.Last_Index).Line_Region.Last + New_Line_Count;
   end Line_At_Node;
   ...
   function Line_At_Node
     ...
     return Line_Number_Type
   is begin
      return Tree.Line_At_Node (Tree.To_Stream_Node_Parents (Ref), Parse_Stream);
   end Line_At_Node;
   ...
   begin
      ...
      Last_Non_Grammar_Is_Node_Non_Grammar := Actual_Last_Non_Grammar = Last_Terminal;
   ...
   begin
      Line_Region_Internal_1
        (Tree, Node, Prev_Non_Grammar, Next_Non_Grammar, Trailing_Non_Grammar,
         First_Non_Grammar_Token, Last_Non_Grammar_Token, Last_Non_Grammar_Is_Node_Non_Grammar);
         ...
         declare
            ...
            EOI : constant Node_Access :=
              (if Last_Node.ID = Tree.Lexer.Descriptor.EOI_ID
               then Last_Node
               elsif Last_Node.Children (Last_Node.Child_Count).ID = Tree.Lexer.Descriptor.EOI_ID
            ...
            begin
               ...
               if New_Root.Children (New_Root.Children'Last).ID /= Tree.Lexer.Descriptor.EOI_ID then
                  Last := @ + 1;
