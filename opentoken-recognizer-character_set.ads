...
--
-- Update History:
-- $Log: opentoken-recognizer-character_set.ads,v $
...
-- The most useful use of this facility in a typical application is locating
-- strings of "whitespace"
-------------------------------------------------------------------------------
package Opentoken.Recognizer.Character_Set is

   -- A typical definition set for whitespace. Use Ada.Strings.Maps.To_Set and
   -- Ada.Strings.Maps."&" create your own superset of this.
   ...
   ----------------------------------------------------------------------------
   -- This procedure will be called to create a Character_Set token. Set should
   -- be given a string containing all the characters that can be part of the
   -- token. The Set may be created using the operations in Ada.Strings.Maps.
   -- Putting EOL_Character in the set is perfectly acceptable, but
   -- EOF_Character is not a good idea.
   --
   -- It defaults to non-reportable because the typical use of this facility
   -- is for ignoring whitespace
   ----------------------------------------------------------------------------
