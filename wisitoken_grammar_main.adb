   ...
   begin
      declare
         ...
         is begin
            ...
            Add_Goto (Table.States (34), 33, 46);
            ...
            Add_Goto (Table.States (36), 32, 47);
            Add_Goto (Table.States (36), 33, 35);
            Add_Action (Table.States (37), (11, 12, 19, 21, 24), (37, 0), 1, null, null);
            Add_Action (Table.States (38), 12, 48);
            Add_Action (Table.States (38), 19, 49);
            Add_Action (Table.States (38), 21, 50);
            Add_Error (Table.States (38));
            Add_Action (Table.States (39), (12, 19, 21), (35, 0), 1, null, null);
            Add_Action (Table.States (40), 11, 51);
            Add_Action (Table.States (40), 12, Reduce, (36, 1), 1, null, null);
            Add_Action (Table.States (40), 19, Reduce, (36, 1), 1, null, null);
            Add_Action (Table.States (40), 21, Reduce, (36, 1), 1, null, null);
            Add_Action (Table.States (40), 24, 52);
            Add_Error (Table.States (40));
            Add_Action (Table.States (41), (19, 24, 27), (29, 1), 4, declaration_1'Access, null);
            Add_Action (Table.States (42), (9, 24), (31, 1), 2, null, null);
            Add_Action (Table.States (43), 24, 53);
            Add_Error (Table.States (43));
            Add_Action (Table.States (44), 16, 54);
            Add_Error (Table.States (44));
            Add_Action (Table.States (45), 16, 55);
            Add_Error (Table.States (45));
            Add_Action (Table.States (46), (8, 10, 14, 15, 17, 19, 20, 22, 23, 24, 25, 26, 27), (32, 1), 2, null,
            null);
            Add_Action (Table.States (47), 8, 23);
            Add_Action (Table.States (47), 10, 24);
            Add_Action (Table.States (47), 14, 25);
            Add_Action (Table.States (47), 15, 26);
            Add_Action (Table.States (47), 17, 27);
            Add_Action (Table.States (47), 19, Reduce, (29, 0), 4, declaration_0'Access, null);
            Add_Action (Table.States (47), 20, 28);
            Add_Action (Table.States (47), 22, 29);
            Add_Action (Table.States (47), 23, 30);
            Add_Action (Table.States (47), 24, 31, (29, 0), 4, declaration_0'Access, null);
            Add_Action (Table.States (47), 25, 32);
            Add_Action (Table.States (47), 26, 33);
            Add_Action (Table.States (47), 27, Reduce, (29, 0), 4, declaration_0'Access, null);
            Add_Error (Table.States (47));
            Add_Goto (Table.States (47), 33, 46);
            Add_Action (Table.States (48), 12, Reduce, (36, 0), 0, null, null);
            Add_Action (Table.States (48), 19, Reduce, (36, 0), 0, null, null);
            Add_Action (Table.States (48), 21, Reduce, (36, 0), 0, null, null);
            Add_Action (Table.States (48), 24, 37);
            Add_Error (Table.States (48));
            Add_Goto (Table.States (48), 36, 56);
            Add_Goto (Table.States (48), 37, 40);
            Add_Action (Table.States (49), 4, 57);
            Add_Action (Table.States (49), 5, 58);
            Add_Error (Table.States (49));
            Add_Action (Table.States (50), (19, 24, 27), (34, 0), 4, nonterminal_0'Access, null);
            Add_Action (Table.States (51), 11, 59);
            Add_Action (Table.States (51), 12, Reduce, (36, 2), 2, null, null);
            Add_Action (Table.States (51), 19, Reduce, (36, 2), 2, null, null);
            Add_Action (Table.States (51), 21, Reduce, (36, 2), 2, null, null);
            Add_Error (Table.States (51));
            Add_Action (Table.States (52), (11, 12, 19, 21, 24), (37, 1), 2, null, null);
            Add_Action (Table.States (53), (19, 24, 27), (29, 4), 5, declaration_4'Access, null);
            Add_Action (Table.States (54), (1 =>  24), (30, 1), 4, null, null);
            Add_Action (Table.States (55), (1 =>  24), (30, 2), 4, null, null);
            Add_Action (Table.States (56), (12, 19, 21), (35, 1), 3, null, null);
            Add_Action (Table.States (57), 5, 60);
            Add_Error (Table.States (57));
            Add_Action (Table.States (58), 24, 61);
            Add_Error (Table.States (58));
            Add_Action (Table.States (59), (12, 19, 21), (36, 3), 3, null, null);
            Add_Action (Table.States (60), (12, 19, 21), (35, 3), 4, null, null);
            Add_Action (Table.States (61), 15, 62);
            Add_Error (Table.States (61));
            Add_Action (Table.States (62), 24, 63);
            Add_Error (Table.States (62));
            Add_Action (Table.States (63), (12, 19, 21), (35, 2), 6, null, null);
         end Subr_1;
      begin
         Subr_1;
      end;
