...
--
--  Copyright (C) 2004 - 2007, 2009, 2012, 2015, 2018 - 2019, 2021 Stephen Leake.  All Rights Reserved.
--
...
package AUnit.Checks is
   ...
   generic
      type Item_Type (<>) is limited private;
      type Item_Access_Type is access constant Item_Type;
