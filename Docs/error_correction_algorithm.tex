...
and De Vere \citep{McKenzie 1995} are described, including
...
\citep{FMQ 1980} for an LL parser:
\begin{equation}
...
\bibitem[Grune, 2008]{Grune 2008} Dick Grune, Ceriel J.H. Jacobs: ``Parsing Techniques; A Practical Guide, Second
  Edition''. Springer Science  2008.

\bibitem[McKenzie, 1995]{McKenzie 1995} McKenzie, Bruce J., Yeatman, Corey, and De
...
\bibitem[Leake, 2020]{Emacs Ada mode news}Emacs Ada mode news:
  \url{http://www.nongnu.org/ada-mode/NEWS-ada-mode.text}

\bibitem[ISO, 2012]{Ada 2012}Ada 2012 language standard:
  \url{http://ada-auth.org/standards/ada12.html}

\bibitem[ISO, 2020]{Ada 2020}Ada 2020 draft 25: http://www.ada-auth.org/standards/ada2x.html

\bibitem[Gosling, 2019]{javarm}Java language grammar:
  \url{https://docs.oracle.com/javase/specs/jls/se12/html/index.html}

\bibitem[DeRemer, 1982]{DeRemer 1982} Frank DeRemer, Thomas Pennello: Efficient
...
\bibitem[Aho Ullman, 1985]{dragon}Alfred V. Aho, Ravi Sethi, Jeffrey D. Ullman.
  Compilers: Principles, Techniques, and Tools. Addison-Wesley 1985

\bibitem[Tomita, 1986]{Tomita 1986} Masaru Tomita. Efficient parsing for natural language. Kluwer Academic Publishers, Boston, 1986.

\bibitem[FMQ, 1980]{FMQ 1980}Fischer, C.N., Milton, D.R., Quiring, S.B.:
  Efficient LL(1) error correction and recovery using only insertions.
  Acta Inf. 13(2), 141-154 (1980)

\bibitem[Johnson, 1975]{graph-cycles}Donald B. Johnson, Finding all the Elementary Circuits of a Directed Graph.
SIAM J. Comput. Vol 4, No. 1, March 1975.\\ \verb|https://epubs.siam.org/doi/abs/10.1137/0204007|

\bibitem[Cormen, 2009]{algorithms 2009} Introduction to Algorithms, Third Edition.
    Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest. The MIT
    Press, 2009.

\bibitem[Leake, 2020]{wisitoken}\url{https://stephe-leake.org/ada/wisitoken.html}
\bibitem[AdaCore libadalang, 2020]{libadalang}\url{https://github.com/AdaCore/libadalang}
\bibitem[AdaCore GNAT studio, 2020]{gnat-studio}\url{https://www.adacore.com/gnatpro/toolsuite/gnatstudio}

\bibitem[Brunsfeld, 2020]{tree-sitter}\url{https://github.com/tree-sitter/tree-sitter}
