...
-- mimic a case reported by a user (they blame CM merge for the
-- mixed line endings). This breaks the parser communications
-- protocol due to character/byte count mismatch.
