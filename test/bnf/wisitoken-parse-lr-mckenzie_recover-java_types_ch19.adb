...
with Java_Types_Ch19_Actions;
package body WisiToken.Parse.LR.McKenzie_Recover.Java_Types_Ch19 is

   use all type Java_Types_Ch19_Actions.Token_Enum_ID; -- token names

   Descriptor : WisiToken.Descriptor renames Java_Types_Ch19_Actions.Descriptor;
   ...
   begin
      ...
      if Config.Stack.Depth = 1 and Tokens (1) = Descriptor.EOI_ID then
         ...
         when GREATER_ID =>
            Matching_Begin_Tokens := To_Vector (+LESS_ID);
         when others =>
...
end WisiToken.Parse.LR.McKenzie_Recover.Java_Types_Ch19;
