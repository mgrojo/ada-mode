...
package body Dragon_4_45_LALR_Test is
   ...
   package FastToken_AUnit is new Gen_FastToken_AUnit
     (Token_ID, Lower_C_ID, EOF_ID, EOF_ID, Tokens_Pkg, Nonterminal, Production,
      Lexer_Root, Parser_Root, First_State_Index, LR, Generators, Grammar);
   use FastToken_AUnit;
   ...
   is
      ...
      --  FIXME: add param to LR0_Kernels (and change name?) to do LALR kernel combining
      ...
      Goto_36 : constant Set_Reference_Ptr :=
        (I89, Upper_C_ID, null) &
          (I47, Lower_D_ID, null) &
          (I36, Lower_C_ID, null);
   begin
