...
package Ada_Mode is
   ...
   --EMACSCMD:(progn (forward-line 2)(forward-word 2)(wisi-goto-spec/body)(looking-at (cl-ecase ada-xref-tool (gpr_query "Separate_Procedure is separate")(gnat "Separate_Procedure is$"))))
   --EMACSRESULT:t
