...
with AUnit.Checks;
package FastToken.AUnit is

   procedure Check is new Standard.AUnit.Checks.Gen_Check_Discrete (Ada.Containers.Count_Type);

   procedure Check is new Standard.AUnit.Checks.Gen_Check_Discrete (FastToken.Token_ID);
   ...
   procedure Check
     is new Standard.AUnit.Checks.Gen_Check_Unconstrained_Array
       (Item_Type   => Boolean,
        ...
        Check_Index => FastToken.AUnit.Check,
   ...
   procedure Check
     is new Standard.AUnit.Checks.Gen_Check_Unconstrained_2D_Array
       (Item_Type     => Boolean,
        ...
        Check_Index_1 => FastToken.AUnit.Check,
        Check_Index_2 => FastToken.AUnit.Check,
        Check_Item    => Standard.AUnit.Checks.Check);
