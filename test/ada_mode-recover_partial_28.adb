                           ...
                           when Shift =>
                              if Checking_Next then
                                 ...
                                 begin
                                    ...
                                    --EMACSCMD:(progn (forward-line 1)(forward-symbol 2)(wisi-replay-kbd-macro "\r"))
                                    Tree.Left_Breakdown (Current_Token, Syntax_Trees.User_Data_Access_Constant (Shared_Parser.User_Data));
                                    --EMACSCMD:(progn (forward-line -1)(delete-indentation))
...
end Ada_Mode.Recover_Partial_28;
--  Local_Variables:
