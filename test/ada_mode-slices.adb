...
procedure Ada_Mode.Slices is
   ...
   --EMACSCMD:(when (eq ada-xref-tool 'gpr_query) (forward-line 2)(forward-word 1)(forward-char 1)(wisi-goto-spec/body)(looking-at "+\" (Left : in Day; Right : in Integer) return Day$"))
   ...
   --EMACSRESULT: "Sun"
   D1, D2 : Day := +Sun;
   --EMACSCMD:(when (eq ada-xref-tool 'gpr_query) (end-of-line 0)(backward-char 5)(wisi-goto-spec/body)(looking-at "+\" (Item"))
   --EMACSRESULT: (eq ada-xref-tool 'gpr_query)
   --EMACSCMD:(progn (end-of-line -2)(backward-char 4)(wisi-goto-spec/body)(looking-at "Sun, Mon,"))
   --EMACSRESULT: t
