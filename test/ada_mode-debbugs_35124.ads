...
-- partial parse does not include the package start, and the error
-- recovery inserts 'begin', leaving a labeled block, in which the
-- label is not highlighted.
...
--EMACSDEBUG:(which-function-mode)
