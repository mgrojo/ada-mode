...
is
            ...
            for RHS of Rule.Right_Hand_Sides loop
               if Length (RHS.Action) > 0 and then not Is_Elisp (RHS.Action) then
                  ...
                  begin
                     ...
                     Action_Names (Rule_Index) := new String'(Name);
               ...
               if Length (RHS.Check) > 0 and then not Is_Elisp (RHS.Check) then
                  ...
                  begin
                     ...
                     Check_Names (Rule_Index) := new String'(Name & "_check");
   ...
   begin
      ...
      Create_Create_Parser
        (Data.Generator_Algorithm, None, Input_Data.Generate_Params.First_State_Index,
...
begin
   Common.Initialize (Input_Data.Lexer.File_Name, Output_File_Name_Root, Check_Interface => False);
   ...
   begin
      ...
      Create_Ada_Main_Spec
        (Input_Data.Lexer.File_Name, Output_File_Name_Root & "_main.ads", Main_Package_Name, Ada, None);
   end;
