...
package body Wisi_Grammar is
   ...
   begin
      ...
      Set_Production (Table.Productions (1), 1, (36, 25));
      Set_Production (Table.Productions (2), 1, (17, 28, 22, 29));
      Set_Production (Table.Productions (3), 1, (17, 22, 29));
      Set_Production (Table.Productions (4), 1, (17, 22));
      Set_Production (Table.Productions (5), 1, (17, 4, 22, 14, 22));
      Set_Production (Table.Productions (6), 1, (17, 3, 4));
      Set_Production (Table.Productions (7), 1, (1 => 5));
      Set_Production (Table.Productions (8), 1, (6, 16, 22, 15));
      Set_Production (Table.Productions (9), 1, (7, 16, 22, 15));
      Set_Production (Table.Productions (10), 1, (1 => 30));
      Set_Production (Table.Productions (11), 1, (29, 30));
      Set_Production (Table.Productions (12), 1, (1 => 13));
      Set_Production (Table.Productions (13), 1, (1 => 22));
      Set_Production (Table.Productions (14), 1, (1 => 14));
      Set_Production (Table.Productions (15), 1, (1 => 21));
      Set_Production (Table.Productions (16), 1, (1 => 9));
      Set_Production (Table.Productions (17), 1, (1 => 20));
      Set_Production (Table.Productions (18), 1, (1 => 23));
      Set_Production (Table.Productions (19), 1, (1 => 24));
      Set_Production (Table.Productions (20), 1, (1 => 7));
      Set_Production (Table.Productions (21), 1, (22, 12, 32, 19));
      Set_Production (Table.Productions (22), 1, (1 => 33));
      Set_Production (Table.Productions (23), 1, (32, 11, 33));
      Set_Production (Table.Productions (24), 1, (32, 17, 4, 22, 14, 22));
      Set_Production (Table.Productions (25), 1, (32, 17, 3, 4));
      Set_Production (Table.Productions (26), 1, (1 .. 0 => <>));
      Set_Production (Table.Productions (27), 1, (1 => 34));
      Set_Production (Table.Productions (28), 1, (34, 10));
      Set_Production (Table.Productions (29), 1, (34, 10, 10));
      Set_Production (Table.Productions (30), 1, (1 => 22));
      Set_Production (Table.Productions (31), 1, (34, 22));
      Set_Production (Table.Productions (32), 1, (1 => 8));
      Set_Production (Table.Productions (33), 1, (1 => 27));
      Set_Production (Table.Productions (34), 1, (1 => 18));
      Set_Production (Table.Productions (35), 1, (1 => 31));
      Set_Production (Table.Productions (36), 1, (1 => 35));
      Set_Production (Table.Productions (37), 1, (36, 35));
      ...
      Add_Action (Table.States (0), (1 => 1), 8, 1);
      Add_Action (Table.States (0), (1 => 1), 17, 2);
      Add_Action (Table.States (0), (1 => 1), 18, 3);
      Add_Action (Table.States (0), (1 => 1), 22, 4);
      Add_Error (Table.States (0));
      Add_Goto (Table.States (0), 1, 27, 5);
      Add_Goto (Table.States (0), 1, 31, 6);
      Add_Goto (Table.States (0), 1, 35, 7);
      ...
      Add_Action (Table.States (2), (1 => 1), 3, 11);
      Add_Action (Table.States (2), (1 => 1), 4, 12);
      Add_Action (Table.States (2), (1 => 1), 5, 13);
      Add_Action (Table.States (2), (1 => 1), 6, 14);
      Add_Action (Table.States (2), (1 => 1), 7, 15);
      Add_Action (Table.States (2), (1 => 1), 22, 16);
      Add_Error (Table.States (2));
      Add_Goto (Table.States (2), 1, 28, 17);
      ...
      Add_Action (Table.States (4), (1 => 1), 12, 10);
      ...
      Add_Action (Table.States (8), (1 => 1), 8, 1);
      Add_Action (Table.States (8), (1 => 1), 17, 2);
      Add_Action (Table.States (8), (1 => 1), 18, 3);
      Add_Action (Table.States (8), (1 => 1), 22, 4);
      Add_Action (Table.States (8), 25, Accept_It, 1, 26, 1, 0, null, null);
      Add_Error (Table.States (8));
      Add_Goto (Table.States (8), 1, 27, 5);
      Add_Goto (Table.States (8), 1, 31, 6);
      Add_Goto (Table.States (8), 1, 35, 9);
      ...
      Add_Action (Table.States (10), (1 => 1), 22, 34);
      Add_Error (Table.States (10));
      Add_Goto (Table.States (10), 1, 32, 35);
      Add_Goto (Table.States (10), 1, 33, 36);
      Add_Goto (Table.States (10), 1, 34, 37);
      Add_Action (Table.States (11), (1 => 1), 4, 33);
      Add_Error (Table.States (11));
      Add_Action (Table.States (12), (1 => 1), 22, 32);
      Add_Error (Table.States (12));
      Add_Action (Table.States (13), 22, Reduce, 7, 28, 1, 0, null, null);
      Add_Error (Table.States (13));
      Add_Action (Table.States (14), (1 => 1), 16, 31);
      Add_Error (Table.States (14));
      Add_Action (Table.States (15), (1 => 1), 16, 30);
      Add_Error (Table.States (15));
      Add_Action (Table.States (16), (1 => 1), 7, 19);
      Add_Action (Table.States (16), 8, Reduce, 4, 27, 2, 2, declaration_2'Access, null);
      Add_Action (Table.States (16), (1 => 1), 9, 20);
      Add_Action (Table.States (16), (1 => 1), 13, 21);
      Add_Action (Table.States (16), (1 => 1), 14, 22);
      ...
      Add_Action (Table.States (16), (1 => 1), 20, 23);
      Add_Action (Table.States (16), (1 => 1), 21, 24);
      Add_Action (Table.States (16), (1 => 1), 22, 25, 4, 27, 2, 2, declaration_2'Access, null);
      Add_Action (Table.States (16), (1 => 1), 23, 26);
      Add_Action (Table.States (16), (1 => 1), 24, 27);
      Add_Action (Table.States (16), 25, Reduce, 4, 27, 2, 2, declaration_2'Access, null);
      Add_Error (Table.States (16));
      Add_Goto (Table.States (16), 1, 29, 28);
      Add_Goto (Table.States (16), 1, 30, 29);
      Add_Action (Table.States (17), (1 => 1), 22, 18);
      Add_Error (Table.States (17));
      Add_Action (Table.States (18), (1 => 1), 7, 19);
      Add_Action (Table.States (18), (1 => 1), 9, 20);
      Add_Action (Table.States (18), (1 => 1), 13, 21);
      Add_Action (Table.States (18), (1 => 1), 14, 22);
      Add_Action (Table.States (18), (1 => 1), 20, 23);
      Add_Action (Table.States (18), (1 => 1), 21, 24);
      Add_Action (Table.States (18), (1 => 1), 22, 25);
      Add_Action (Table.States (18), (1 => 1), 23, 26);
      Add_Action (Table.States (18), (1 => 1), 24, 27);
      Add_Error (Table.States (18));
      Add_Goto (Table.States (18), 1, 29, 47);
      Add_Goto (Table.States (18), 1, 30, 29);
      ...
      Add_Action (Table.States (28), (1 => 1), 7, 19);
      Add_Action (Table.States (28), 8, Reduce, 3, 27, 3, 1, declaration_1'Access, null);
      Add_Action (Table.States (28), (1 => 1), 9, 20);
      Add_Action (Table.States (28), (1 => 1), 13, 21);
      Add_Action (Table.States (28), (1 => 1), 14, 22);
      ...
      Add_Action (Table.States (28), (1 => 1), 20, 23);
      Add_Action (Table.States (28), (1 => 1), 21, 24);
      Add_Action (Table.States (28), (1 => 1), 22, 25, 3, 27, 3, 1, declaration_1'Access, null);
      Add_Action (Table.States (28), (1 => 1), 23, 26);
      Add_Action (Table.States (28), (1 => 1), 24, 27);
      Add_Action (Table.States (28), 25, Reduce, 3, 27, 3, 1, declaration_1'Access, null);
      Add_Error (Table.States (28));
      Add_Goto (Table.States (28), 1, 30, 46);
      ...
      Add_Action (Table.States (30), (1 => 1), 22, 45);
      Add_Error (Table.States (30));
      Add_Action (Table.States (31), (1 => 1), 22, 44);
      Add_Error (Table.States (31));
      Add_Action (Table.States (32), (1 => 1), 14, 43);
      ...
      Add_Action (Table.States (35), (1 => 1), 11, 40);
      Add_Action (Table.States (35), (1 => 1), 17, 41);
      Add_Action (Table.States (35), (1 => 1), 19, 42);
      ...
      Add_Action (Table.States (37), (1 => 1), 10, 38);
      ...
      Add_Action (Table.States (37), (1 => 1), 22, 39);
      Add_Error (Table.States (37));
      Add_Action (Table.States (38), (1 => 1), 10, 54);
      ...
      Add_Action (Table.States (40), (1 => 1), 22, 34);
      Add_Error (Table.States (40));
      Add_Goto (Table.States (40), 1, 33, 53);
      Add_Goto (Table.States (40), 1, 34, 37);
      Add_Action (Table.States (41), (1 => 1), 3, 51);
      Add_Action (Table.States (41), (1 => 1), 4, 52);
      ...
      Add_Action (Table.States (43), (1 => 1), 22, 50);
      Add_Error (Table.States (43));
      Add_Action (Table.States (44), (1 => 1), 15, 49);
      Add_Error (Table.States (44));
      Add_Action (Table.States (45), (1 => 1), 15, 48);
      ...
      Add_Action (Table.States (47), (1 => 1), 7, 19);
      Add_Action (Table.States (47), 8, Reduce, 2, 27, 4, 0, declaration_0'Access, null);
      Add_Action (Table.States (47), (1 => 1), 9, 20);
      Add_Action (Table.States (47), (1 => 1), 13, 21);
      Add_Action (Table.States (47), (1 => 1), 14, 22);
      ...
      Add_Action (Table.States (47), (1 => 1), 20, 23);
      Add_Action (Table.States (47), (1 => 1), 21, 24);
      Add_Action (Table.States (47), (1 => 1), 22, 25, 2, 27, 4, 0, declaration_0'Access, null);
      Add_Action (Table.States (47), (1 => 1), 23, 26);
      Add_Action (Table.States (47), (1 => 1), 24, 27);
      Add_Action (Table.States (47), 25, Reduce, 2, 27, 4, 0, declaration_0'Access, null);
      Add_Error (Table.States (47));
      Add_Goto (Table.States (47), 1, 30, 46);
      ...
      Add_Action (Table.States (51), (1 => 1), 4, 56);
      Add_Error (Table.States (51));
      Add_Action (Table.States (52), (1 => 1), 22, 55);
      ...
      Add_Action (Table.States (55), (1 => 1), 14, 57);
      ...
      Add_Action (Table.States (57), (1 => 1), 22, 58);
