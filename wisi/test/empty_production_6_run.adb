...
with Empty_Production_6; use Empty_Production_6;
procedure Empty_Production_6_Run
is
   procedure Put_Usage
   is begin
      Put_Line ("usage: empty_production_6_run [-v] filename");
