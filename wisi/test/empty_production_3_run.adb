...
with Empty_Production_3; use Empty_Production_3;
procedure Empty_Production_3_Run
is
   procedure Put_Usage
   is begin
      Put_Line ("usage: empty_production_3_run [-v] filename");
