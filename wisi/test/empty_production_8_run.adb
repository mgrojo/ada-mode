...
with Empty_Production_8; use Empty_Production_8;
procedure Empty_Production_8_Run
is
   procedure Put_Usage
   is begin
      Put_Line ("usage: empty_production_8_run [-v] filename");
