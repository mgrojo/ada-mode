...
project Ada_Mode_Wisi_Parse is
   ...
   for Main use
     ("ada_mode_wisi_lalr_parse.ads",
      ...
      "ada_mode_wisi_packrat_gen_parse.ads",
      "run_ada_lalr_parse.ads",
      "run_ada_lr1_parse.ads",
      "run_ada_packrat_gen_parse.ads",
      "run_ada_packrat_proc_parse.ads",
      "gpr_mode_wisi_lr1_parse.ads",
      "gpr_mode_wisi_packrat_gen_parse.ads",
      "gpr_query.adb"
     );
