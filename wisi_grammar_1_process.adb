...
package body Wisi_Grammar_1_Process is
   ...
   begin
      ...
      when Navigate =>
         Statement_Action (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((1, Statement_Start), (3, Name)));
      when Face =>
         Face_Apply_Action (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((1, 5, 0), (2, 5, 2), (3, 5, 1)));
      when Indent =>
         null;
      end case;
   end declaration_0;
   ...
   begin
      ...
      when Navigate =>
         null;
      when Face =>
         Face_Apply_Action (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((1, 5, 0), (2, 5, 2)));
      when Indent =>
         null;
      end case;
   end declaration_1;
   ...
   begin
      ...
      when Navigate =>
         null;
      when Face =>
         Face_Apply_Action (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((1, 5, 0), (2, 5, 2), (3, 5, 2)));
      when Indent =>
         null;
      end case;
   end declaration_4;
   ...
   begin
      ...
      when Navigate =>
         null;
      when Face =>
         Face_Apply_Action (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, (1 => (3, 5, 4)));
      when Indent =>
         null;
      end case;
   ...
   begin
      ...
      when Navigate =>
         null;
      when Face =>
         Face_Apply_Action (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, (1 => (1, 5, 3)));
      when Indent =>
         null;
      end case;
   ...
   begin
      ...
      when Face =>
         Face_Apply_Action (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, (1 => (1, 5, 1)));
      when Indent =>
         Indent_Action_0 (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((False, (Simple, (Int, 0))), (True, (Simple, (Int, 2)), (Simple, (Int, -1))), (False, (Simple, (Int, 2))), (False, (Simple, (Int, 2)))));
      end case;
   end nonterminal_0;
   ...
   begin
      ...
      when Face =>
         null;
      when Indent =>
         Indent_Action_0 (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((False, (Simple, (Int, 0))), (False, (Simple, (Int, -2))), (False, (Simple, (Int, 0))), (False, (Simple, (Int, 0))), (False, (Simple, (Int, 0))), (False, (Simple, (Int, 0)))));
      end case;
   end rhs_list_2;
   ...
   begin
      ...
      when Face =>
         null;
      when Indent =>
         Indent_Action_0 (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((False, (Simple, (Int, 0))), (False, (Simple, (Int, -2))), (False, (Simple, (Int, 0))), (False, (Simple, (Int, 0)))));
      end case;
   end rhs_list_3;
   ...
   begin
      ...
      when Face =>
         null;
      when Indent =>
         Indent_Action_0 (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((True, (Hanging_0, (Int, 0), (Int, 2)), (Simple, (Int, -1))), (True, (Simple, (Int, 2)), (Simple, (Int, -1)))));
      end case;
   end rhs_2;
   ...
   begin
      ...
      when Face =>
         null;
      when Indent =>
         Indent_Action_0 (Parse_Data, Tree, Tree_Nonterm, Tree_Tokens, ((True, (Hanging_0, (Int, 0), (Int, 2)), (Simple, (Int, -1))), (True, (Simple, (Int, 2)), (Simple, (Int, -1))), (True, (Simple, (Int, 2)), (Simple, (Int, -1)))));
      end case;
   end rhs_3;
   ...
   begin
      ...
      Add_Action (Table.States (1), 8, Reduce, 32, 35, 1, 0, null, null);
      Add_Action (Table.States (1), 17, Reduce, 32, 35, 1, 0, null, null);
      Add_Action (Table.States (1), 18, Reduce, 32, 35, 1, 0, null, null);
      Add_Action (Table.States (1), 22, Reduce, 32, 35, 1, 0, null, null);
      Add_Action (Table.States (1), 25, Reduce, 32, 35, 1, 0, null, null);
      ...
      Add_Action (Table.States (20), 7, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 8, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 9, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 13, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 14, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 17, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 18, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 20, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 21, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 22, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 23, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 24, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      Add_Action (Table.States (20), 25, Reduce, 16, 30, 1, 4, declaration_item_4'Access, null);
      ...
      Add_Action (Table.States (38), 11, Reduce, 28, 33, 2, 2, rhs_2'Access, null);
      Add_Action (Table.States (38), 17, Reduce, 28, 33, 2, 2, rhs_2'Access, null);
      Add_Action (Table.States (38), 19, Reduce, 28, 33, 2, 2, rhs_2'Access, null);
      ...
      Add_Action (Table.States (48), 22, Reduce, 9, 28, 4, 2, token_keyword_non_grammar_2'Access, null);
      Add_Error (Table.States (48));
      Table.States (49).Productions := WisiToken.LR.To_Vector ((1 => 8));
      Add_Action (Table.States (49), 22, Reduce, 8, 28, 4, 1, token_keyword_non_grammar_1'Access, null);
      ...
      Add_Action (Table.States (54), 11, Reduce, 29, 33, 3, 3, rhs_3'Access, null);
      Add_Action (Table.States (54), 17, Reduce, 29, 33, 3, 3, rhs_3'Access, null);
      Add_Action (Table.States (54), 19, Reduce, 29, 33, 3, 3, rhs_3'Access, null);
      ...
      Add_Action (Table.States (56), 11, Reduce, 25, 32, 4, 3, rhs_list_3'Access, null);
      Add_Action (Table.States (56), 17, Reduce, 25, 32, 4, 3, rhs_list_3'Access, null);
      Add_Action (Table.States (56), 19, Reduce, 25, 32, 4, 3, rhs_list_3'Access, null);
      ...
      Add_Action (Table.States (58), 11, Reduce, 24, 32, 6, 2, rhs_list_2'Access, null);
      Add_Action (Table.States (58), 17, Reduce, 24, 32, 6, 2, rhs_list_2'Access, null);
      Add_Action (Table.States (58), 19, Reduce, 24, 32, 6, 2, rhs_list_2'Access, null);
