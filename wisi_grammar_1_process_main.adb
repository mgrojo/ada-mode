...
package body Wisi_Grammar_1_Process_Main is
   ...
   begin
      ...
      Table.Productions.Set_First (26);
      Table.Productions.Set_Last (37);
      Set_Production (Table.Productions (26), 26, 0);
      Set_RHS (Table.Productions (26), 0, (37, 25));
      Set_Production (Table.Productions (27), 27, 5);
      Set_RHS (Table.Productions (27), 0, (18, 28, 22, 30));
      Set_RHS (Table.Productions (27), 1, (18, 3, 29, 9));
      Set_RHS (Table.Productions (27), 2, (18, 22, 30));
      Set_RHS (Table.Productions (27), 3, (18, 22));
      Set_RHS (Table.Productions (27), 4, (18, 5, 22, 15, 22));
      Set_RHS (Table.Productions (27), 5, (18, 4, 5));
      Set_Production (Table.Productions (28), 28, 2);
      Set_RHS (Table.Productions (28), 0, (1 => 6));
      Set_RHS (Table.Productions (28), 1, (7, 17, 22, 16));
      Set_RHS (Table.Productions (28), 2, (8, 17, 22, 16));
      Set_Production (Table.Productions (29), 29, 1);
      Set_RHS (Table.Productions (29), 0, (1 => 22));
      Set_RHS (Table.Productions (29), 1, (29, 22));
      Set_Production (Table.Productions (30), 30, 1);
      Set_RHS (Table.Productions (30), 0, (1 => 31));
      Set_RHS (Table.Productions (30), 1, (30, 31));
      Set_Production (Table.Productions (31), 31, 8);
      Set_RHS (Table.Productions (31), 0, (1 => 14));
      Set_RHS (Table.Productions (31), 1, (1 => 22));
      Set_RHS (Table.Productions (31), 2, (1 => 15));
      Set_RHS (Table.Productions (31), 3, (1 => 21));
      Set_RHS (Table.Productions (31), 4, (1 => 10));
      Set_RHS (Table.Productions (31), 5, (1 => 20));
      Set_RHS (Table.Productions (31), 6, (1 => 23));
      Set_RHS (Table.Productions (31), 7, (1 => 24));
      Set_RHS (Table.Productions (31), 8, (1 => 8));
      Set_Production (Table.Productions (32), 32, 0);
      Set_RHS (Table.Productions (32), 0, (22, 13, 33, 19));
      Set_Production (Table.Productions (33), 33, 3);
      Set_RHS (Table.Productions (33), 0, (1 => 34));
      Set_RHS (Table.Productions (33), 1, (33, 12, 34));
      Set_RHS (Table.Productions (33), 2, (33, 18, 5, 22, 15, 22));
      Set_RHS (Table.Productions (33), 3, (33, 18, 4, 5));
      Set_Production (Table.Productions (34), 34, 3);
      Set_RHS (Table.Productions (34), 0, (1 .. 0 => <>));
      Set_RHS (Table.Productions (34), 1, (1 => 35));
      Set_RHS (Table.Productions (34), 2, (35, 11));
      Set_RHS (Table.Productions (34), 3, (35, 11, 11));
      Set_Production (Table.Productions (35), 35, 1);
      Set_RHS (Table.Productions (35), 0, (1 => 22));
      Set_RHS (Table.Productions (35), 1, (35, 22));
      Set_Production (Table.Productions (36), 36, 1);
      Set_RHS (Table.Productions (36), 0, (1 => 27));
      Set_RHS (Table.Productions (36), 1, (1 => 32));
      Set_Production (Table.Productions (37), 37, 1);
      Set_RHS (Table.Productions (37), 0, (1 => 36));
      Set_RHS (Table.Productions (37), 1, (37, 36));
      ...
      Add_Goto (Table.States (0), (36, 0), 27, 3);
      Add_Goto (Table.States (0), (36, 1), 32, 4);
      Add_Goto (Table.States (0), (37, 0), 36, 5);
      Add_Goto (Table.States (0), (26, 0), 37, 6);
      Table.States (1).Productions := WisiToken.To_Vector (((27, 0), (27, 1), (27, 2), (27, 3), (27, 4), (27, 5)));
      ...
      Add_Goto (Table.States (1), (27, 0), 28, 16);
      ...
      Add_Goto (Table.States (6), (36, 0), 27, 3);
      Add_Goto (Table.States (6), (36, 1), 32, 4);
      Add_Goto (Table.States (6), (37, 1), 36, 7);
      ...
      Add_Goto (Table.States (8), (32, 0), 33, 36);
      Add_Goto (Table.States (8), (33, 0), 34, 37);
      Add_Goto (Table.States (8), (34, 1), 35, 38);
      Table.States (9).Productions := WisiToken.To_Vector ((1 => (27, 1)));
      Add_Action (Table.States (9), (1 => (29, 0)), 22, 33);
      Add_Error (Table.States (9));
      Add_Goto (Table.States (9), (27, 1), 29, 34);
      ...
      Add_Goto (Table.States (15), (27, 2), 30, 27);
      Add_Goto (Table.States (15), (30, 0), 31, 28);
      ...
      Add_Goto (Table.States (17), (27, 0), 30, 50);
      Add_Goto (Table.States (17), (30, 0), 31, 28);
      ...
      Add_Goto (Table.States (27), (30, 1), 31, 49);
      ...
      Add_Goto (Table.States (41), (33, 1), 34, 56);
      Add_Goto (Table.States (41), (34, 1), 35, 38);
      ...
      Add_Goto (Table.States (50), (30, 1), 31, 49);
